...
mqttClient.on('connect', () => {
  ...
  mqttClient.subscribe('restaurant/tables/+/occupied', (err) => {
    if (err) console.error('Erreur de souscription à occupied:', err);
    else console.log('Abonné à restaurant/tables/+/occupied');
  });
